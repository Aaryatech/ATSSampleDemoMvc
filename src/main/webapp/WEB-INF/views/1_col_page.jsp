						...
						<div class="card">
								...
								<table width="100%">
									<tr width="100%">
										<td width="60%"><h5 class="pageTitle">
												<i class="icon-list-unordered"></i>1 Column Form Input ([2-10],[3-9])*1
											</h5></td>
							...
							<div class="card-body">
								...
								<form
									...
									<div class="form-group row">
										<label class="col-form-label font-weight-bold col-lg-3"
...
<div class="form-group row">
									...
									<div class="form-group row">
										<label
											class="col-form-label text-info font-weight-bold  col-lg-3 float">Basic
											radio group <span class="text-danger">*</span>:
										</label>
										<div class="col-lg-9 float">
