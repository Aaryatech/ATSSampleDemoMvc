...
.white-txt.select2-selection--single {
	...
	<ul class="navbar-nav"
		...
		<li class="nav-item dropdown"><a href="#"
			...
			data-toggle="dropdown" aria-expanded="false"> <!-- <i class="icon-people"></i> -->
				<i class="far fa-bell"></i> <span class="d-md-none ml-2">Users</span>
		</a>
		...
		<li class="nav-item dropdown"><a href="#"
			...
			data-toggle="dropdown" aria-expanded="false"> <i
				class="icon-bubbles4"></i> <span class="d-md-none ml-2">Messages</span>
			...
			<div
				...
				<div class="dropdown-content-footer justify-content-center p-0">
					<a href="#" class="bg-light text-grey w-100 py-2"
						data-popup="tooltip" title="" data-original-title="Load more"><i
